...
const Task = ({ task }) => {
  ...
  return (
    <div className="border-2 border-gray-300 rounded-lg p-6 grid grid-cols-1 lg:grid-cols-12 gap-3 lg:items-center">
      <img
        className="w-[200px] h-[200px] object-cover rounded-lg mx-auto lg:col-span-3"
        src={company?.logo}
        alt=""
      />
